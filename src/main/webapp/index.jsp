...
<body id="page-top">
	...
	<nav
		...
		id="mainNav">
		<div class="container">
			<a class="navbar-brand" href="#page-top">Sharuk's Website</a>
			<button
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ms-auto">
					...
					<li class="nav-item mx-0 mx-lg-1 bg-danger" style="border-radius: 45%"><form action="Logout" method="post">
						<input class="nav-link py-3 px-0 px-lg-3 rounded" type="submit" value = "Logout"> </form></li>
					<li class="nav-item mx-0 mx-lg-1" style="background-color: rgb(102,102,255); border-radius: 45%; font-color:black"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="login.jsp"><%= session.getAttribute("name") %> </a></li>
	...
	<header class="masthead bg-primary text-white text-center">
		<div class="container d-flex align-items-center flex-column">
			...
			<img class="masthead-avatar mb-5" src="assets/img/avataaars.svg"
				alt="..." />
			<!-- Masthead Heading-->
			<h1 class="masthead-heading text-uppercase mb-0">Welcome To Shark's Blog</h1>
			<!-- Icon Divider-->
